...
int main()
{
	...
	for (i = 1; i < 41; i++)  strcpy_s(clvarlt[i], "");
...
1 at
		...
		//Fill conclusion list
	strcpy_s(conclt[1], "PO");
	strcpy_s(conclt[2], "QU");
	strcpy_s(conclt[3], "PO");
	strcpy_s(conclt[4], "PO");
	strcpy_s(conclt[5], "PO");
	strcpy_s(conclt[6], "PO");
...
key. */
	...
	strcpy_s(clvarlt[1], "DE");
	strcpy_s(clvarlt[5], "DE");
	strcpy_s(clvarlt[9], "DE");
	strcpy_s(clvarlt[10], "DI");
	strcpy_s(clvarlt[13], "QU");
	strcpy_s(clvarlt[14], "GR");
	strcpy_s(clvarlt[15], "EX");
	strcpy_s(clvarlt[17], "QU");
	strcpy_s(clvarlt[18], "GR");
	strcpy_s(clvarlt[19], "EX");
	strcpy_s(clvarlt[21], "QU");
	strcpy_s(clvarlt[22], "GR");
	for (i = 1; i < 9; i++)
	{
		printf("** CLAUSE %d\n", i);
		for (j = 1; j < 5; j++)
